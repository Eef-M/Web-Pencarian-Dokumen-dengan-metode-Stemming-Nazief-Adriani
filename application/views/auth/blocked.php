...
<head>
    ...
    <link href="<?= base_url('assets/auth/') ?>vendor/fontawesome-free/css/all.min.css" rel="stylesheet"
        type="text/css">
    <link
            ...
            <div id="content">
                ...
                <div class="container-fluid mt-5">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-gray-500 mb-0">Tidak berhak mengakses halaman ini</p>
                        <a href="<?= base_url('user/landingpage') ?>">&larr; Back to Dashboard</a>
                    </div>
